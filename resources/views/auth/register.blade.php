    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-2">
                ...
                <select id="country"
                    class="block mt-1 w-full select2 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
        ...
        <x-slot name="extra">
            <p class="text-center text-gray-600 my-4">
                Already have an account? <a href="{{ route('login') }}"
                    class="underline hover:text-gray-900">Login</a>.
            </p>
        </x-slot>
