...
<header class="header header-sticky mb-4">
    <div class="container-fluid">
        ...
        <a class="header-brand d-md-none" href="#">
            <img class="sidebar-brand-full" src="{{ asset(setting('site_logo')) }}" height="46" alt="{{ setting('app_name') }}">
        </a>
        <ul class="header-nav d-none d-md-flex">
            <li class="nav-item"><a class="nav-link" href="{{ route('frontend.index') }}" target="_blank">{{setting('app_name')}}&nbsp;<i class="cil-external-link"></i></a></li>
        </ul>
