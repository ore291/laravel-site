        ...
        <div class="container">
            ...
            <div class="col-md-12" style="font-family: verdana; line-height: 35px;">
                ...
                <p>3. Login to your account after successful registration, verify your account details and then click on
                    make
                    payment <br> &nbsp; &nbsp; available on your dashboard. </p>
                ...
                <div style="border-left: solid; padding-left: 20px;">
                    <!--<h1 style="font-size: 22px; dtext-align: center; font-family: arial black; font-style: italic; color: green;">PAY VIA PAYPAL </h1>

        PayPal email address: <b> Eyitoyo.olajide@yahoo.com </b>
        <br>
        After making payments, send the payer’s email address, name, and amount to contact@sportverified.com. <br>
        Send a screenshot of your payment details also as an attachment.
        Your account will be upgraded as soon as we confirm your payment.
        Thanks. -->
                    <h1
                    ...
                    <p>Select Pay with Flutterwave <br> Choose your preferred plan <br> Enter your card details - Card
                        ...
                        <br>Once
                        payment is successful, You will be redirected back to our website where you will automatically be
                        upgraded. </p>
                ...
                <div style="margin-left: 10px; color: #aaa; margin-bottom: 30px;">
                    ...
                    <p style="font-size: 12px; line-height: 28px;">Please be informed that will be no refunds and and
                        credits
                        are not exchangeable for cash. By opting to receive soccer prediction and tips, you accept that all
                        Sport Verified predictions and tips are for informational purpose are tips are for informational
                        purposes only and that Sport Verified will take responsibility for any loses incurred by you, the
                        subscriber as a direct result of acting upon received Sport Verified information. We do not
                        encourage
                        gambling in any sort of form. Users under 18 years old must seek parental consent.
