  ...
  <div class="p-2 max-w-5xl  mx-auto">
    ...
    <div v-show="currentStep === 0">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-20 place-content-center ">
        <div @click="selectPaymentOption(option.value)" class="cursor-pointer transition ease-out hover:scale-105"
          v-for="(option, i) in ng_payment_options" :key="i">
        ...
        <div class="border border-black" v-for="plan in plans" :key="plan.id">
          ...
          <ul class="p-2">
            ...
            <button @click="selectPlan(plan, 'm')">
              <li><span class="glyphicon glyphicon-ok"></span> &nbsp; <b class="pricez">{{ plan.n_per_month_f }} -
                  Monthly</b></li>
            </button>
            <button @click="selectPlan(plan, '6m')" v-if="plan.id != 6">
              <li><span class="glyphicon glyphicon-ok"></span> &nbsp; <b class="pricez">{{ plan.n_per_6months_f }}
                  - 6
                  Months</b></li>
            </button>
            <button @click="selectPlan(plan, 'y')" v-if="plan.id != 6">
              <li><span class="glyphicon glyphicon-ok"></span> &nbsp; <b class="pricez">{{ plan.n_per_year_f }} -
                  1
                  Year</b></li>
            </button>
          </ul>
    ...
    <div v-show="currentStep === 3 && payment_option === 0 && selectCard === true">
      <div class="w-full">
        ...
        <h1 style="font-size: 20px; dtext-align: center; font-family: arial black; font-style: italic; color: Green;">
        </h1>
        <div class="w-full" style="dheight: 300px; dborder:solid; border-width: thin; padding-top: 20px;">
          ...
          <div class="w-full"
            ...
            <ul style="text-align: left; font-size: 20px; font-weight: bold; font-family: calibri;">
              ...
              <li><span class="glyphicon glyphicon-ok"></span> &nbsp;<b id="email">{{ user.email }}</b></li>
            ...
            <div class="w-full flex justify-center ">
              <div v-if="selectedPlan !== {} && payment_method === 1">
                <paystack :amount="0 || getAmount.a" :email="user.email" :paystackkey="paystackkey" :reference="reference"
...
export default {
  ...
  data() {
    return {
      paystackkey: "pk_test_9da36d88c1d36b3beaab17754e6a92d2ad64ccaf",
      user: null,
      selectedPlan: {},
      selectedDuration: "",
      totalSteps: 3,
