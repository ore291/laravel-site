        ...
        <div class="card-body">
            ...
            <div class="row mt-4">
                ...
                <div class="col-12 col-md-6">
                    <p>{{ $prediction->country }}</p>

                    <p>{{ $prediction->team_a }} vs {{ $prediction->team_b }}</p>
                    <p>
                    ...
                    <p>
                        Date: {{ date('D d,M Y', strtotime($prediction->date_t)) }}
                    </p>
                    <p>
                        Time: {{ date('h:i A', strtotime($prediction->time_t)) }}
                    </p>
