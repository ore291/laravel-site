                    ...
                    <table id="example" class="table table-responsive display" style="width:100%" data-paging="false" data-searching="false"
                        ...
                        <thead>
                            <tr class="text-nowrap">
                                <th style="width : 200px;">League/Country</th>
                                <th>Team A</th>
                                <th>Team B</th>
                                <th>Category</th>
                                <th>Tips</th>
...
@push('after-scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            for (i = 0; i < additional; i++) {
                rows.push([
                    `<input  required name="prediction[${i}][country]"  style="width: 200px"  type="text" class="form-control" />`,
        ...
        `<input  required style="width:80px;" class="form-control" type="text" id="row-1-age"
            ...
            table.row.add([
            `<input  required name="prediction[${additional}][country]" type="text" class="form-control" />`,`<input required style="width: 200px" class="form-control" type="text" id="row-1-team-a"
    ...
    <script>
        const sendPred = async (result) => {
            ...
            axios.post('/api/other_sports/bulk', body)
